...
if __name__ == "__main__":
    ...
    for voiceID in glob.glob('/home/david/Dropbox/Python3/Praat/audio/*.wav'):
        voice_measurements = measure_voices(voiceID)
        for measure in voice_measurements:
            print(measure)
